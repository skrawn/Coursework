// ======================================================================
// Optical_Demo.v generated from TopDesign.cysch
// 02/27/2016 at 20:34
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=255, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=4080, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_DAC, CY_INSTANCE_SHORT_NAME=LED_DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=LED_DAC, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_Buffer, CY_INSTANCE_SHORT_NAME=ADC_Buffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=ADC_Buffer, )
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1000008, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=55556, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR, CY_INSTANCE_SHORT_NAME=ADC_SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=ADC_SAR, )
module ADC_SAR_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("11c46d00-9279-4f06-90a2-700d54871e46/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("11c46d00-9279-4f06-90a2-700d54871e46/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("01ee2c0b-8299-4c5c-b599-a045a8790986/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=CapSense_CompCH0, )
module Comp_v2_0_5 (
    Vplus,
    CmpOut,
    Vminus,
...
// IDAC8_v2_0(Current=0, Data_Source=0, Hardware_Enable=true, IDAC_Range=4, IDAC_Speed=0, Initial_Value=0, Polarity=4, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IdacCH0, CY_INSTANCE_SHORT_NAME=IdacCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=CapSense_IdacCH0, )
module IDAC8_v2_0_6 (
    iOut,
    data,
    strobe,
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_Follower, CY_INSTANCE_SHORT_NAME=LED_Follower, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=LED_Follower, )
...
module top ;
    ...
    VDAC8_v1_90_0 LED_DAC (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_364));
    defparam LED_DAC.Data_Source = 0;
    defparam LED_DAC.Initial_Value = 255;
    defparam LED_DAC.Strobe_Mode = 0;
    ...
    cy_annotation_universal_v1_0 GREEN_LED (
        .connect({
            Net_41,
            Net_30
        })
    );
    defparam GREEN_LED.comp_name = "LED_v1_0";
    defparam GREEN_LED.port_names = "A, K";
    defparam GREEN_LED.width = 2;
    ...
    defparam LED_Mux.muxin_width = 4;
    defparam LED_Mux.init_mux_sel = 4'h0;
    defparam LED_Mux.one_active = 1;
    defparam LED_Mux.connect_mode = 2;
    ...
    OpAmp_v1_90_1 ADC_Buffer (
        .Vplus(Net_475),
        .Vout(Net_490),
        .Vminus(Net_476));
    defparam ADC_Buffer.Mode = 1;

	wire [0:0] tmpOE__P6_1_net;
	wire [0:0] tmpIO_0__P6_1_net;
	wire [0:0] tmpINTERRUPT_0__P6_1_net;
	electrical [0:0] tmpSIOVREF__P6_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		P6_1
		 (.oe(tmpOE__P6_1_net),
		  .y({1'b0}),
		  .fb({Net_111}),
		  .io({tmpIO_0__P6_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P6_1_net),
		  .interrupt({tmpINTERRUPT_0__P6_1_net[0:0]}),
		  .annotation({Net_306}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P6_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8f28ed60-cd57-4446-b6b5-b997e2dcbfde"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("047b8721-ecc6-41d2-bf0d-84512da95f54"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 IR_LED (
        .connect({
            Net_292,
            Net_290
        })
    );
    defparam IR_LED.comp_name = "LED_v1_0";
    defparam IR_LED.port_names = "A, K";
    defparam IR_LED.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("48e82bb0-9cf5-43a2-8961-036c96fb8410"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cdf72098-0772-495e-8acf-59f3b65d1fad"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("292d6334-0ddc-4d97-a503-e7df0578d824"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__P15_5_net;
	wire [0:0] tmpIO_0__P15_5_net;
	wire [0:0] tmpINTERRUPT_0__P15_5_net;
	electrical [0:0] tmpSIOVREF__P15_5_net;

	cy_psoc3_pins_v1_10
		#(.id("dcf9be43-1579-4043-a748-fed2a926e2f8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		P15_5
		 (.oe(tmpOE__P15_5_net),
		  .y({1'b0}),
		  .fb({Net_300}),
		  .io({tmpIO_0__P15_5_net[0:0]}),
		  .siovref(tmpSIOVREF__P15_5_net),
		  .interrupt({tmpINTERRUPT_0__P15_5_net[0:0]}),
		  .annotation({Net_299}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P15_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    // -- AMux Sensor_Mux start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 Sensor_Mux(
        .muxin({
            Net_392,
            Net_338,
            Net_439
    ...
    defparam Sensor_Mux.muxin_width = 3;
    defparam Sensor_Mux.init_mux_sel = 3'h0;
    defparam Sensor_Mux.one_active = 1;
    defparam Sensor_Mux.connect_mode = 2;
    
    // -- AMux Sensor_Mux end --

    CharLCD_v2_20_4 LCD ();

    CapSense_CSD_v3_40_7 CapSense (
        .clock(1'b0),
        .shield(Net_353),
        .vref(Net_354),
        .bclk(Net_355));

    OpAmp_v1_90_8 LED_Follower (
        .Vplus(Net_364),
        .Vout(Net_261),
        .Vminus(Net_369));
    defparam LED_Follower.Mode = 1;
