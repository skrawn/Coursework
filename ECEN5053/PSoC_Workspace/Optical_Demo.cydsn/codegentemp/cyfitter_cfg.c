...
#define BS_DSI3_3_HV_ROUTING_VAL ((const uint8 CYFAR *)0x48001118u)

/* DSI3_4_HV_ROUTING Address: CYDEV_UCFG_DSI1_BASE + 0x00000080u Size (bytes): 128 */
#define BS_DSI3_4_HV_ROUTING_VAL ((const uint8 CYFAR *)0x48001198u)

/* DSISWITCH_1_5 Address: CYDEV_UCFG_DSI0_BASE Size (bytes): 128 */
#define BS_DSISWITCH_1_5_VAL ((const uint8 CYFAR *)0x48001218u)

/* DSI3_5_HV_ROUTING Address: CYDEV_UCFG_DSI0_BASE + 0x00000080u Size (bytes): 128 */
#define BS_DSI3_5_HV_ROUTING_VAL ((const uint8 CYFAR *)0x48001298u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48001318u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48001320u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x4800132Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48001334u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x4800133Cu)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48001344u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 16u, 0x0Bu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT4_DR) },	/* TD 10 */
		{ 16u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT12_DR) },	/* TD 11 */
		{ 384u, 0x0Du, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 12 */
		{ 384u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_U0_BASE) },	/* TD 13 */
		{ 384u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U0_BASE) },	/* TD 14 */
		{ 384u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_U0_BASE) },	/* TD 15 */
		{ 384u, 0x11u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_U0_BASE) },	/* TD 16 */
		...
		{ 128u, 0x18u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 23 */
		{ 128u, 0x19u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 24 */
		{ 16u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL1_MDCLK_EN) },	/* TD 25 */
		{ 7u, 0x1Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT5_BASE) },	/* TD 26 */
		{ 7u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT6_BASE) },	/* TD 27 */
		{ 7u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT15_BASE) },	/* TD 28 */
		{ 8u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_SAR1_SW0) },	/* TD 29 */
		...
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE + 0x00000080u) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 41 */
		...
		{ 128u, 0x32u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 49 */
		{ 128u, 0x33u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE + 0x00000080u) },	/* TD 50 */
		...
		{ 128u, 0x36u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE) },	/* TD 53 */
		{ 128u, 0x37u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 54 */
		{ 128u, 0x38u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 55 */
		{ 128u, 0x39u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE) },	/* TD 56 */
		...
		{ 128u, 0x3Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P7_ROUTE_BASE + 0x00000080u) },	/* TD 60 */
		{ 128u, 0x3Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_ROUTE_BASE + 0x00000080u) },	/* TD 61 */
		{ 128u, 0x3Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 62 */
		...
		{ 128u, 0x43u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 66 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_IOPORT_6_VAL),	/* TD 27 */
		(const void *)(BS_IOPORT_8_VAL),	/* TD 28 */
		...
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 50 */
		...
		(const void *)(BS_UDB_2_3_HV_ROUTING_VAL),	/* TD 55 */
		(const void *)(BS_UDBSWITCH_0_4_VAL),	/* TD 56 */
		...
		(const void *)(BS_UDB_1_5_HV_ROUTING_VAL),	/* TD 60 */
		(const void *)(BS_UDB_2_5_HV_ROUTING_VAL),	/* TD 61 */
		(const void *)(BS_DSISWITCH_1_0_VAL),	/* TD 62 */
		(const void *)(BS_DSI3_0_HV_ROUTING_VAL),	/* TD 63 */
		(const void *)(BS_DSISWITCH_1_1_VAL),	/* TD 64 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 65 */
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 66 */
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC3_SW0, 0xE0u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_OPAMP0_SW, 0x01u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP1_MX, 0x0108u);
...
uint8 CYXDATA * const CYCODE LED_Mux__addrTable[8] = {
	(uint8 CYXDATA *)CYREG_OPAMP1_SW, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE LED_Mux__maskTable[8] = {
	0x02u, 0x00u, 
	0x60u, 0x00u, 
	0x48u, 0x00u, 
	0xC0u, 0x00u, 
...
*
*******************************************************************************/
void LED_Mux_Set(uint8 channel)
{
	if (channel < 4)
	{
		channel += channel;
		*LED_Mux__addrTable[channel] |= LED_Mux__maskTable[channel];
		channel++;
		*LED_Mux__addrTable[channel] |= LED_Mux__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void LED_Mux_Unset(uint8 channel)
{
	if (channel < 4)
	{
		channel += channel;
		*LED_Mux__addrTable[channel] &= (uint8)~LED_Mux__maskTable[channel];
		channel++;
		*LED_Mux__addrTable[channel] &= (uint8)~LED_Mux__maskTable[channel];
	}
}

static uint8 CYXDATA * const CYCODE Sensor_Mux__outerAddr[3] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
	(uint8 CYXDATA *)CYREG_DAC3_SW3, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};

static const uint8 CYCODE Sensor_Mux__outerMask[3] = {
	0x40u, 
	0x80u, 
	0x01u, 
};

static uint8 CYXDATA * const CYCODE Sensor_Mux__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_OPAMP0_MX, 
};

static const uint8 CYCODE Sensor_Mux__innerMask[1] = {
	0x01u, 
};

static const uint8 CYCODE Sensor_Mux__innerMap[3] = {
	0u, 
	0u, 
	0u, 
};

static uint8 Sensor_Mux__armsEnabled = 0u;
static uint8 Sensor_Mux__refCnt[] = {0u};

/*******************************************************************************
* Function Name: Sensor_Mux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void Sensor_Mux_Set(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 3u) && ((Sensor_Mux__armsEnabled & channelMask) == ((uint32)0u)))
	{
		Sensor_Mux__armsEnabled |= channelMask;
		*Sensor_Mux__outerAddr[channel] |= Sensor_Mux__outerMask[channel];
		i = Sensor_Mux__innerMap[channel];
		if (Sensor_Mux__refCnt[i] == 0u)
		{
			*Sensor_Mux__innerAddr[i] |= Sensor_Mux__innerMask[i];
		}
		Sensor_Mux__refCnt[i]++;
	}
}

/*******************************************************************************
* Function Name: Sensor_Mux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void Sensor_Mux_Unset(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 3u) && ((Sensor_Mux__armsEnabled & channelMask) != ((uint32)0u)))
	{
		Sensor_Mux__armsEnabled &= (uint8)~channelMask;
		*Sensor_Mux__outerAddr[channel] &= (uint8)~Sensor_Mux__outerMask[channel];
		i = Sensor_Mux__innerMap[channel];
		Sensor_Mux__refCnt[i]--;
		if (Sensor_Mux__refCnt[i] == 0)
		{
			*Sensor_Mux__innerAddr[i] &= (uint8)~Sensor_Mux__innerMask[i];
		}
	}
}
