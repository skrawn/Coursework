...
/* LED_Mux__addrTable is an implementation detail of the AMux.
   ...
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE LED_Mux__addrTable[8];
/* LED_Mux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE LED_Mux__maskTable[8];
extern void Sensor_Mux_Set(uint8 channel);
extern void Sensor_Mux_Unset(uint8 channel);
