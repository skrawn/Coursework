// ======================================================================
// Lab3_Optical.v generated from TopDesign.cysch
// 02/24/2016 at 20:11
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Photodiode_Source, CY_INSTANCE_SHORT_NAME=Photodiode_Source, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Photodiode_Source, )
...
// OpAmp_v1_90(Mode=0, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PhotoDiode_Amp, CY_INSTANCE_SHORT_NAME=PhotoDiode_Amp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=PhotoDiode_Amp, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Diode_Follower, CY_INSTANCE_SHORT_NAME=Diode_Follower, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Diode_Follower, )
...
module top ;
	...
	wire [0:0] tmpOE__P6_6_net;
	wire [0:0] tmpFB_0__P6_6_net;
	wire [0:0] tmpIO_0__P6_6_net;
	wire [0:0] tmpINTERRUPT_0__P6_6_net;
	electrical [0:0] tmpSIOVREF__P6_6_net;

	cy_psoc3_pins_v1_10
		#(.id("b53d0ea2-9336-446a-a9fd-d5a0a80a3484"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P6_6
		 (.oe(tmpOE__P6_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P6_6_net[0:0]}),
		  .analog({Net_106}),
		  .io({tmpIO_0__P6_6_net[0:0]}),
		  .siovref(tmpSIOVREF__P6_6_net),
		  .interrupt({tmpINTERRUPT_0__P6_6_net[0:0]}),
		  .annotation({Net_41}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P6_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 Red_LED (
        .connect({
            Net_41,
            Net_30
        })
    );
    defparam Red_LED.comp_name = "LED_v1_0";
    defparam Red_LED.port_names = "A, K";
    defparam Red_LED.width = 2;
    ...
    cy_annotation_universal_v1_0 Phototransistor (
        .connect({
            Net_43,
            Net_154
        })
    );
    defparam Phototransistor.comp_name = "PhotoTrans_v1_0";
    defparam Phototransistor.port_names = "C, E";
    defparam Phototransistor.width = 2;

    cy_annotation_universal_v1_0 Photoresistor (
        .connect({
            Net_43,
            Net_152
        })
    );
    defparam Photoresistor.comp_name = "PhotoResistor_v1_0";
    defparam Photoresistor.port_names = "T1, T2";
    defparam Photoresistor.width = 2;
    ...
    defparam LED_Mux.muxin_width = 2;
    defparam LED_Mux.init_mux_sel = 2'h0;
    defparam LED_Mux.one_active = 0;
    defparam LED_Mux.connect_mode = 1;
    ...
    VDAC8_v1_90_2 Photodiode_Source (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_187));
    defparam Photodiode_Source.Data_Source = 0;
    defparam Photodiode_Source.Initial_Value = 0;
    defparam Photodiode_Source.Strobe_Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("01848566-20db-4c03-8128-6cd46fd04a6c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4a07bbb8-1f35-4731-ba32-6b0670f95829"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    OpAmp_v1_90_3 PhotoDiode_Amp (
        .Vplus(Net_183),
        .Vout(Net_181),
        .Vminus(Net_172));
    defparam PhotoDiode_Amp.Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("55467eba-9c77-4375-b6f8-549f23371ef8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a72c1b4-2ed4-4b2c-9790-5a23ac20e33f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    OpAmp_v1_90_4 Diode_Follower (
        .Vplus(Net_187),
        .Vout(Net_193),
        .Vminus(Net_197));
    defparam Diode_Follower.Mode = 1;
