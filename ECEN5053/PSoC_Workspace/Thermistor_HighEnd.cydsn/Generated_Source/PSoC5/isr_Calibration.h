...
#define isr_Calibration_INTC_VECTOR            ((reg32 *) isr_Calibration__INTC_VECT)
...
#define isr_Calibration_INTC_SET_EN            ((reg32 *) isr_Calibration__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the isr_Calibration interrupt. */
#define isr_Calibration_INTC_CLR_EN            ((reg32 *) isr_Calibration__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the isr_Calibration interrupt state to pending. */
#define isr_Calibration_INTC_SET_PD            ((reg32 *) isr_Calibration__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the isr_Calibration interrupt. */
#define isr_Calibration_INTC_CLR_PD            ((reg32 *) isr_Calibration__INTC_CLR_PD_REG)
