// ======================================================================
// Lab5_Multiplexer.v generated from TopDesign.cysch
// 03/20/2016 at 15:15
...
// Sample_Hold_v1_40(Power=2, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=S_H, CY_INSTANCE_SHORT_NAME=S_H, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=S_H, )
module Sample_Hold_v1_40_0 (
    Vin,
    sclk,
    Vout,
    Vref);
...
module top ;
    ...
    defparam MUX.connect_mode = 0;
    
    // -- AMux MUX end --

    Sample_Hold_v1_40_0 S_H (
        .sclk(Net_15),
        .Vin(Net_37),
        .Vout(Net_46),
        .Vref(Net_18));
	...
	cy_psoc3_pins_v1_10
		#(.id("64e3efc7-ee92-46b3-9ec3-9f73b8261a89"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c06c5b59-3563-4979-ba85-ffd6e7a6b675"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
