...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x4800011Cu)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000130u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800013Cu)
